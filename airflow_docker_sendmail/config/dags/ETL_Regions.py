...
def cargar_data(exec_date):
    ...
    table_name = 'flores_laura14_coderhouse.countries'
    # Define the columns you want to insert data into
    columns = columns
    # Generate 
...
def enviar_email(exec_date):
    print(f"Enviando Email: {exec_date}") 
    try:
        ...
        x.sendmail('flores.laura1787@gmail.com','flores.laura1787@gmail.com',message)
        print('El correo fue enviado de forma satisfactoria')
    except Exception as exception:
        print(exception)
        print('El envio ha fallado')
